 ...
 * @author Mitko Kolev
 */
public class FlowManagerApplicationControllerImplMock extends
        FlowManagerApplicationControllerImpl {

    public FlowManagerApplicationControllerImplMock(
            IJMXConnectionManager jMXConnectionManager) {
        super(jMXConnectionManager, new FlowManagerRepositoryImplMock(
