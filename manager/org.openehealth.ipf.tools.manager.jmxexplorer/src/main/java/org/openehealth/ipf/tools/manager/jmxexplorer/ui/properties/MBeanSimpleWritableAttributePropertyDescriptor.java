...
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.SimpleWritableMBeanAttributeCellEditor;
...
public class MBeanSimpleWritableAttributePropertyDescriptor extends
    ...
    public void widgetSelected(SelectionEvent see) {
        ...
        try {
            ...
            Activator.getDefault().error("Cannot write the attribute value", ioe);
        }
