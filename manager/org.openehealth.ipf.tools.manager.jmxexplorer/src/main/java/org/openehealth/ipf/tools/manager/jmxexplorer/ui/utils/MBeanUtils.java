 ...
 */
package org.openehealth.ipf.tools.manager.jmxexplorer.ui.utils;
...
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.properties.CompositeDataArrayPropertySource;
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.properties.CompositeDataPropertySource;
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.properties.MBeanCollectionAttributePropertySource;
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.properties.TabularDataPropertySource;
...
public class MBeanUtils {
     ...
     * @return
     */
    public static Object[] convertPrimitiveArrayToObjectArray(Object object) {
        ...
        Activator.getDefault().error("Must be never entered!");
    ...
    public static String convertPropertySourceValueToString(
            Object propertySourceValue, StringBuilder appendOffset) {
        ...
        if (propertySourceValue instanceof ObjectName) {
            ...
            for (int t = 0; t < descriptors.length; t++) {
                ...
                builder.append(descriptors[t].getDisplayName()).append("=");
                // recursive call
                StringBuilder attributeAppend = new StringBuilder();
                attributeAppend.append(appendOffset).append("\t");
                builder.append(convertPropertySourceValueToString(valueIn,
                        attributeAppend));
                builder.append("]");
            }
