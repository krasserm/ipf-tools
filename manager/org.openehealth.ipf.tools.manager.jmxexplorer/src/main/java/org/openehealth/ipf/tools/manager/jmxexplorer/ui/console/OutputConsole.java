 ...
 */
package org.openehealth.ipf.tools.manager.jmxexplorer.ui.console;
...
public class OutputConsole {
    ...
    public void printOutputThrowable(Throwable t) {
        ...
        try {
            ...
            Activator.getDefault().error(
                    "Error writing to the console " + e.getMessage());
        } finally {
    ...
    public void printMessage(String message, boolean bold) {
        ...
        try {
            ...
            Activator.getDefault().error("Error writing to the console", e);
        } finally {
            closeConsoleStream(stream);
        }
    }
    ...
    protected void closeConsoleStream(MessageConsoleStream stream) {
        ...
        if (stream != null) {
            try {
                ...
                Activator.getDefault().error(
                        "Exception closing the console stream", ioe);
            }
        }
    }
