...
/**
 * Label provider for the JMX Tree TODO:// should be refactored to extend the
 * JMX Connection LabelProvider
 * 
 * @see LabelProvider
 * @see JMXView
 * @author Mitko Kolev
    ...
    public Image getImage(Object obj) {
        ...
        if (obj instanceof JMXConnectionNode) {
            ...
            if (((JMXConnectionNode) obj).hasChildren()) {
                ...
                // if the nodes are updated automatically, they will be updated
                // always when
