 ...
 */
package org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor;
...
import org.openehealth.ipf.tools.manager.jmxexplorer.IJMXExplorerMediator;
import org.openehealth.ipf.tools.manager.jmxexplorer.IMBeanServerConnectionFacade;
import org.openehealth.ipf.tools.manager.jmxexplorer.JMXExplorerEvent;
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.console.OutputConsole;
...
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.utils.MBeanUtils;
import org.openehealth.ipf.tools.manager.jmxexplorer.ui.utils.Messages;
...
public class MBeanAttributeEditor implements IMBeanNodeEditor,
    ...
    private void writeAttributeValue() {
        ...
        try {
            ...
            Activator.getDefault().info("Connection is not accessible", ioe);
        }
    ...
    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.MBeanNodeEditorAbstract#createControl(org.eclipse.swt.widgets.Composite)
     */
    ...
    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.MBeanNodeEditorAbstract#getTargetNode()
     */
    ...
    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.IMBeanNodeEditor#getControl()
     */
    ...
    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.IMBeanNodeEditor#valueChanged()
     */
        ...
        case JMXExplorerEvent.ATTRIBUTE_VALUE_CHANGED:
            if (event.getSource().equals(this.attributeNode.getAttributeInfo())) {
                ...
                Activator.getDefault().info(
                        "Editor for attribute " + this.attributeNode.getName()
                                + " updated");
            }
            break;
        }
    ...
    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.IMBeanNodeEditor#setEnabled(boolean)
     */
    public void setEnabled(boolean enabled) {
        try {
            ...
            Activator.getDefault().error("Error setting enabled state", t);
        }
    }

    /**
     * @see org.openehealth.ipf.tools.manager.jmxexplorer.ui.editor.IMBeanNodeEditor#dispose()
     */
    public void dispose() {
    }
}
