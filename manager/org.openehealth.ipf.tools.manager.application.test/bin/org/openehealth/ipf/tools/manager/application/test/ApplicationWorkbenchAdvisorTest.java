...
import org.openehealth.ipf.tools.manager.application.ApplicationWorkbenchAdvisor;
import org.openehealth.ipf.tools.manager.application.ApplicationWorkbenchWindowAdvisor;
...
public class ApplicationWorkbenchAdvisorTest extends TestCase {
    ...
    public void testIsPerspectiveIdUnchanged() {
        assertTrue(ApplicationWorkbenchAdvisor.PERSPECTIVE_ID
                .equals("org.openehealth.ipf.tools.manager.connection.ui.perspective.DefaultPerspective"));
    }
