...
/**
 * This serializer of the repository is intended to be used only when the
 * connection are serialized on disk.
 * //TODO replace with XML serialization 
 *  
...
public abstract class ConnectionConfigurationRepositoryAbstractSerializer {
    ...
    public String getSerializationGlobalPath() {
        ...
        if (installArea != null) {
            ...
            installArea = File.separator
                    + installArea.replace('/', File.separatorChar);
