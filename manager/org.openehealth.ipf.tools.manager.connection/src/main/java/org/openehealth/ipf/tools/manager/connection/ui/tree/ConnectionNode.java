...
import org.openehealth.ipf.tools.manager.connection.ui.properties.JMXConnectionPropertiesSource;

/**
 * <p>
 * The top element which visualizes a IConnection object in the views.
 * 
 * @see org.openehealth.ipf.tools.manager.connection.ui.tree.Node
 * 
 * @author Mitko Kolev
 */
public class ConnectionNode extends InitializableNodeAbstract {

    private final IPropertySource propertiesSource;
