...
public class FlowManagerSearchMediator implements Observer {
        ...
        searchButton.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                try {
                    service
                            .executeCommand(
                                    "org.openehealth.ipf.tools.manager.flowmanager.ui.search",
                                    null);
    ...
    private synchronized void readAndSetState() {
        try {
            ...
            Activator.getDefault().error("Can not read the state", we); // ignoreit
        } catch (FileNotFoundException fnfe) {
            Activator.getDefault().error("Can not read the state", fnfe); // ignoreit
        }
    }
