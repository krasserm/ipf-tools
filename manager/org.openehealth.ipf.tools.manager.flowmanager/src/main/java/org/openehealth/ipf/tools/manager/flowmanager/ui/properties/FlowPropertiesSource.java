 ...
 */
package org.openehealth.ipf.tools.manager.flowmanager.ui.properties;
...
import org.openehealth.ipf.tools.manager.flowmanager.ui.utils.Messages;

/**
 * IPropertySource2 for both flows and aggregated flow parts (contained in the
 * flows).
 * 
 ...
 * @author Mitko Kolev
 */
public class FlowPropertiesSource implements IPropertySource {

    public final static String DATE_FORMAT = "yyyy.MM.dd HH:mm:ss";

    // flow

    public static final String PARTS_COUNT_ID = "flow.parts.count";

    public static final String SELECTED_FLOW_ID = "selected.flow";

    public static final String REPLY_COUNT_ID = "flow.info.reply.count";

    public static final String REPLYABLE_ID = "flow.info.replyable";

    public static final String ACK_COUNT_ID = "flow.info.ack.count";

    public static final String ACK_EXPECTED_COUNT_ID = "flow.info.ack.expected.count";

    public static final String REPLAY_TIME_ID = "flow.info.reply.time";

    public static final String NAK_COUNT_ID = "flow.info.nak.count";

    public static final String CREATION_TIME_ID = "flow.info.creation.time";

    public static final String ID_ID = "flow.info.id";

    public static final String STATUS_ID = "flow.info.status";

    public static final String APPLICATION_ID = "flow.info.application";

    // flow parts
    public static final String FLOW_PART_ID = "flow.part";

    public static final String FLOW_PART_PATH_ID = "flow.part.path";

    public static final String FLOW_PART_STATUS_ID = "flow.part.status";

    public static final String FLOW_PART_CONTRIBUTION_COUNT_ID = "flow.part.contribution.count";

    public static final String FLOW_PART_FILTER_TIME_ID = "flow.part.filter.time";

    public static final String FLOW_PART_CONTRIBUTION_TIME_ID = "flow.part.contribution.time";

    public static final String FLOW_PART_DURATION_MS_ID = "flow.part.duration.ms";

    // descriptions

    public static final String PARTS_COUNT_DESCRIPTION = "flow.parts.count.description";

    public static final String REPLY_COUNT_DESCRIPTION = "flow.info.reply.count.description";

    public static final String REPLYABLE_DESCRIPTION = "flow.info.replyable.description";

    public static final String ACK_COUNT_DESCRIPTION = "flow.info.ack.count.description";

    public static final String ACK_EXPECTED_COUNT_DESCRIPTION = "flow.info.ack.expected.count.description";

    public static final String REPLY_TIME_DESCRIPTION = "flow.info.reply.time.description";

    public static final String NAK_COUNT_DESCRIPTION = "flow.info.nak.count.description";

    public static final String CREATION_TIME_DESCRIPTION = "flow.info.creation.time.description";

    public static final String ID_DESCRIPTION = "flow.info.id.description";

    public static final String STATUS_DESCRIPTION = "flow.info.status.description";

    public static final String APPLICATION_DESCRIPTION = "flow.info.application.description";

    // part descriptions
    public static final String FLOW_PART_STATUS_DESCRIPTION = "flow.part.status.description";

    public static final String FLOW_PART_CONTRIBUTION_COUNT_DESCRIPTION = "flow.part.contribution.count.description";

    public static final String FLOW_PART_FILTER_TIME_DESCRIPTION = "flow.part.filter.time.description";

    public static final String FLOW_PART_CONTRIBUTION_TIME_DESCRIPTION = "flow.part.contribution.time.description";

    public static final String FLOW_PART_DURATION_MS_DESCRIPTION = "flow.part.duration.ms.description";
    ...
    public IFlowPartInfo getFlowPartById(Object id) {
