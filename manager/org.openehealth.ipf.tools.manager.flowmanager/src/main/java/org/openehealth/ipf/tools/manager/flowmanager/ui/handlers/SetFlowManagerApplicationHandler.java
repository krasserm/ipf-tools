 ...
 * @author Mitko Kolev
 */
public class SetFlowManagerApplicationHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (editor instanceof FlowManagerEditor) {
            ...
            String applicationName = (String) trigger.data;

            new SetFlowManagerApplicationJob(Display.getCurrent(),
                    connectionConfiguration, applicationName).schedule();
        }
        return null;
    }
