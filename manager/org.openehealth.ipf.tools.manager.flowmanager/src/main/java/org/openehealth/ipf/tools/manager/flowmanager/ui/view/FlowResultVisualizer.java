 ...
 */
package org.openehealth.ipf.tools.manager.flowmanager.ui.view;
...
import org.openehealth.ipf.tools.manager.connection.ui.utils.sorter.TableColumnViewerSorter;
...
import org.openehealth.ipf.tools.manager.flowmanager.ui.adapter.FlowInfoAdapter;
import org.openehealth.ipf.tools.manager.flowmanager.ui.adapter.FlowManagerAdapterFactory;
        ...
        public synchronized void run() {
            try {
                ...
                if (editor instanceof FlowManagerEditor) {
                    ...
                    List<IFlowInfo> flows = Activator.getDefault()
                ...
                Activator.getDefault().error("Update table flow results table failed!", t);
            }
        }
    }
