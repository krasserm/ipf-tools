 ...
 */
package org.openehealth.ipf.tools.manager.flowmanager.ui.jobs;
...
import org.openehealth.ipf.tools.manager.connection.ui.utils.jobs.SessionSafeWorkerJob;
...
/**
 * UI job to execute changeFlowCleanup
 * 
 * @see org.openehealth.ipf.tools.manager.flowmanager.IFlowManagerApplicationController#changeFlowCleanup(IConnectionConfiguration)
 * 
 * @author Mitko Kolev
 */
public class ChangeFlowManagerEnableCleanupJob extends SessionSafeWorkerJob {

    private final IConnectionConfiguration connectionConfiguration;

    public ChangeFlowManagerEnableCleanupJob(Display display,
