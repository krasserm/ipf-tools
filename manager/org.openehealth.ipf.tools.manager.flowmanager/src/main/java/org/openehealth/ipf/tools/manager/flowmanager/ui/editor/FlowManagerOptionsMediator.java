 ...
 */
package org.openehealth.ipf.tools.manager.flowmanager.ui.editor;
...
import org.openehealth.ipf.tools.manager.flowmanager.ui.jobs.ChangeFlowManagerEnableCleanupJob;
import org.openehealth.ipf.tools.manager.flowmanager.ui.jobs.ChangeFlowManagerFlowFilteringJob;
import org.openehealth.ipf.tools.manager.flowmanager.ui.jobs.SetFlowManagerApplicationJob;
import org.openehealth.ipf.tools.manager.flowmanager.ui.jobs.SetFlowManagerMaxFlowsJob;
...
public class FlowManagerOptionsMediator implements Observer {
    ...
    public FlowManagerOptionsMediator(Composite parent, IEditorInput input) {
        ...
        Activator.getDefault().getFlowManagerApplicationController()
                .addObserver(this);
    ...
    public void createPartControl(Composite parent) {
        ...
        IFlowManagerRepository flowManagerRepository = Activator.getDefault()
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                try {
                    ...
                    IFlowManagerRepository flowManagerRepository = Activator
                            .getDefault().getFlowManagerApplicationController()
                            .getFlowManagerRepository();
