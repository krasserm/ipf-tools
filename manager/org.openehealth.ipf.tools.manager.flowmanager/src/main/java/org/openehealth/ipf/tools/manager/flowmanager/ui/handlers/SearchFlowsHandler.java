...
import org.openehealth.ipf.tools.manager.flowmanager.ui.jobs.SearchFlowsJob;
 ...
 * @author Mitko Kolev
 */
public class SearchFlowsHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (editor != null) {
            if (editor instanceof FlowManagerEditor) {
                ...
                IFlowManagerSearchCriteria criteria = fmEditor
                        .buildSearchCriteria();
                if (criteria == null) {
                    // do not start the search, the criteria is invalid
                    return null;
                }

                new SearchFlowsJob(Display.getCurrent(),
                        connectionConfiguration, criteria).schedule();
            }
        }
        return null;
    }
