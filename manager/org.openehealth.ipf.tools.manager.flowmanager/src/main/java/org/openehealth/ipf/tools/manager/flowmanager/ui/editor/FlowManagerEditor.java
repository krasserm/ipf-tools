...
import org.openehealth.ipf.tools.manager.flowmanager.ui.view.SearchView;
 ...
 * 
 * @see org.openehealth.ipf.tools.manager.connection.ui.editor.ConnectionEditorInput
 * 
 * @author Mitko Kolev
 */
public class FlowManagerEditor extends EditorPart {
    ...
    public FlowManagerEditor() {
        super();
        flowManagerApplicationController = Activator.getDefault()
    ...
    public void createPartControl(Composite parent) {
        ...
        try {
            ...
            Activator.getDefault().error("Cannot show the Flow View", e);
        }
