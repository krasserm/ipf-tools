The IPF Tools project focuses on tools for the eHealth Integration Framework "(IPF)":http://github.com/krasserm/ipf. The tools are based on the Eclipse Rich Client Platform (RCP):
